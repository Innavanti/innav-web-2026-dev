...
export const LangSwitcher2 = () => {
  ...
  return (
    <button
      className="flex flex-row border border-white bg-white/5 text-white backdrop-blur-sm rounded-full w-full max-w-24 max-h-10 px-3 py-1 h-full lg:text-sm aspect-16/11 items-center justify-evenly gap-3 cursor-pointer"
